...
class PublishPipelineTest(unittest.TestCase):
    ...
    def test_daily_publish_workflow_is_manual_dry_run_supabase_connection(self):
        ...
        self.assertIn("X_API_KEY: ${{ secrets.X_API_KEY }}", text)
        self.assertIn("X_API_SECRET: ${{ secrets.X_API_SECRET }}", text)
        self.assertIn("X_ACCESS_TOKEN: ${{ secrets.X_ACCESS_TOKEN }}", text)
        self.assertIn("X_ACCESS_TOKEN_SECRET: ${{ secrets.X_ACCESS_TOKEN_SECRET }}", text)
        self.assertNotIn("X_CLIENT_ID", text)
        self.assertNotIn("X_REFRESH_TOKEN", text)
