...
class FrontendMarkupTest(unittest.TestCase):
    ...
    def test_daily_summary_ribbon_does_not_shift_article_flow(self):
        ...
        self.assertIn('line: "Don\'t Die."', html)
        self.assertIn('kicker: "Don\'t Die."', html)
        self.assertIn('ariaLabel: "Don\'t Die. 요약 열기"', html)
    ...
    def test_model_focus_main_card_gets_live_treatment(self):
        ...
        self.assertIn("DAILY · 일일 알짜배기", html)
        self.assertIn("const liveCta = isModelFocusArticle(a) ? `<div class=\"model-live-cta\">오늘의 알짜배기 열기</div>` : '';", html)
