...
def merge_evaluator_results(results: list[dict[str, Any]], *, require_verdict: bool = False) -> dict[str, Any]:
...
def run_loop(spec_path: str | Path, run_root: str | Path, max_rounds: int) -> dict[str, Any]:
    ...
    while True:
        ...
        merged = merge_evaluator_results(evaluator_results, require_verdict=require_verdict)
